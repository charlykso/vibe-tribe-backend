    ...
    posts: {
        create: {
            body: Joi.object({
                ...
                platforms: Joi.array().items(Joi.string().valid('twitter', 'linkedin', 'instagram', 'facebook')).min(1).required(),
...
export const validators = {
    ...
    objectIdParam: (paramName = 'id') => validateRequest({
        params: Joi.object({
    ...
    fileUpload: validateRequest({
        body: Joi.object({
            ...
            mimetype: Joi.string().valid('image/jpeg', 'image/png', 'image/gif', 'image/webp', 'video/mp4', 'video/webm', 'application/pdf').required(),
...
export const customValidators = {
    ...
    ownershipValidation: (resourceField = 'userId') => {
        return (req, res, next) => {
