...
router.post('/upload', upload.single('file'), asyncHandler(async (req: AuthenticatedRequest, res) => {
  if (!req.file) {
...
router.delete('/:publicId', asyncHandler(async (req: AuthenticatedRequest, res) => {
...
router.post('/optimize-url', asyncHandler(async (req: AuthenticatedRequest, res) => {
  ...
  try {
    ...
    throw new BadRequestError(
      error instanceof Error ? error.message : 'Failed to generate optimized URL'
    );
  }
}));
...
router.get('/stats', asyncHandler(async (req: AuthenticatedRequest, res) => {
  try {
    ...
    throw new BadRequestError(
      error instanceof Error ? error.message : 'Failed to get upload statistics'
    );
  }
}));
