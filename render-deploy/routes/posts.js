...
router.post('/', asyncHandler(async (req, res) => {
    ...
    const createdPost = { id: createdPostDoc.id, ...createdPostDoc.data() };
...
router.put('/:id', asyncHandler(async (req, res) => {
    ...
    const existingPost = { id: postDoc.id, ...postDoc.data() };
    // Verify post belongs to same organization
...
router.get('/drafts', asyncHandler(async (req, res) => {
    ...
    const draftsWithUsers = await Promise.all(drafts.map(async (draft) => {
        if (draft.user_id) {
