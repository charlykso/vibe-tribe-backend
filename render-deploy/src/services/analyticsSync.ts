...
import { SocialAccount, Analytics, CreateAnalytics } from '../types/database.js';
...
export class AnalyticsSyncService {
   ...
   */
  async syncOrganizationAnalytics(organizationId: string): Promise<void> {
   ...
   */
  async syncAccountAnalytics(account: SocialAccount): Promise<void> {
   ...
   */
  private async syncTwitterAnalytics(account: SocialAccount): Promise<void> {
   ...
   */
  private async syncLinkedInAnalytics(account: SocialAccount): Promise<void> {
    if (!account.access_token) {
   ...
   */
  private async syncFacebookAnalytics(account: SocialAccount): Promise<void> {
    if (!account.access_token) {
   ...
   */
  private async syncInstagramAnalytics(account: SocialAccount): Promise<void> {
    if (!account.access_token) {
   ...
   */
  private async storeAnalytics(analytics: CreateAnalytics): Promise<void> {
    const analyticsData = {
      ...analytics,
   ...
   */
  private async storePostAnalytics(
