...
// Simple API testing script for VibeTribe backend
...
async function testSocialAccountsEndpoints() {
  ...
  const platformsResult = await apiRequest('/social-accounts/platforms/supported');
...
async function runTests() {
  console.log('🧪 VibeTribe API Testing Suite');
  console.log('================================');
  ...
  try {
    ...
    if (authToken) {
      ...
      results.socialAccounts = socialResult.getResult.success || socialResult.platformsResult.success;
    }
